...
public class EventUserDAO {
    ...
    public void addUserRole(User user, Event event, Roles roles) throws SQLException{
    ...
    public List<User> getUserRole(Event event, Roles roles) throws SQLException{
    ...
    public void removeUserRole (User user, Event event, Roles roles) throws SQLException, NullPointerException{
